      ...
      <Project
        ...
        implementation={[
          <ul key={uuid()}>
            ...
            <li key={Date.now()}>SFML {"→"} Graphical User Interface</li>
          </ul>,
        ]}
      ...
      <Project
        ...
        implementation={[
          <ul key={uuid()}>
            ...
            <li key={uuid()}>NodeJS, Socket.io</li>
            <li key={uuid()}>
              EJS Templates {"→"} Simple markup error handling
            </li>
      ...
      <Project
        ...
        implementation={[
          <ul key={uuid()}>
            ...
            <li key={uuid()}>NodeJS, ExpressJS, MongoDB, Socket.io</li>
